...
import com.yu.bizmq.BiMessageProducer;
...
import com.yu.model.dto.chart.ChartQueryRequest;
import com.yu.model.dto.chart.ChartUpdateRequest;
import com.yu.model.dto.chart.GenChartByAiRequest;
import com.yu.model.entity.Chart;
import com.yu.model.entity.User;
import com.yu.model.vo.BiResponse;
import com.yu.service.ChartService;
import com.yu.service.UserService;
import com.yu.utils.ExcelUtils;
...
//                "{明确的数据分析结论、越详细越好，不要生成多余的注释}";
     ...
     */
    @PostMapping("/test")
    public BaseResponse<String> genChartByAi(String content, HttpServletRequest request) {
...
//         3号,30
        ...
        String genChart = splits[1].trim();
        String genResult = splits[2].trim();
        return ResultUtils.success(genResult);
    }
