...
import ${packageName}.modules.${moduleName}.model.dto.${dataKey}.${upperDataKey}AddRequest;
import ${packageName}.modules.${moduleName}.model.dto.${dataKey}.${upperDataKey}EditRequest;
import ${packageName}.modules.${moduleName}.model.dto.${dataKey}.${upperDataKey}QueryRequest;
import ${packageName}.modules.${moduleName}.model.dto.${dataKey}.${upperDataKey}UpdateRequest;
import ${packageName}.modules.${moduleName}.model.entity.${upperDataKey};
import ${packageName}.model.entity.User;
import ${packageName}.modules.${moduleName}.model.vo.${upperDataKey}VO;
import ${packageName}.modules.${moduleName}.service.${upperDataKey}Service;
